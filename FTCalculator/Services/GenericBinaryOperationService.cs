...
namespace FTCalculator.Services
{
    ...
    /// </summary>
    public class GenericBinaryOperationService : IGenericBinaryOperationService
    {
        ...
        public T ComputeByOperator<T>(Operator op, T valueOne, T valueTwo) where T : INumber<T>
        {
            switch(op)
            {
                case Operator.Add: return this.Add(valueOne, valueTwo);
                case Operator.Subtract: return this.Subtract(valueOne, valueTwo);
                case Operator.Multiply: return this.Multiply(valueOne, valueTwo);
                case Operator.Divide: return this.Divide(valueOne, valueTwo);
